...
namespace Altarboy
{
...

    {
        ...
        public static Dictionary<string, SpellTypes> PriestSpellTypes
        {
            get
            {
                var _spells = new Dictionary<string, SpellTypes>();
              
               // Damage Over Time Spells
               _spells.Add("Devouring Plague", SpellTypes.DamageOverTime);
               _spells.Add("Holy Fire", SpellTypes.DamageOverTime);
               _spells.Add("Vampiric Touch", SpellTypes.DamageOverTime);
               _spells.Add("Shadow Word: Pain", SpellTypes.DamageOverTime);

               // Channeled Damage Spells
               _spells.Add("Mind Flay", SpellTypes.Channeled);
               _spells.Add("Mind Sear", SpellTypes.Channeled);

               // Direct Damage Spells
               _spells.Add("Mind Blast", SpellTypes.DirectDamage );
               _spells.Add("Mind Spike", SpellTypes.DirectDamage);
               _spells.Add("Shadow Word: Death", SpellTypes.DirectDamage);
               _spells.Add("Shoot", SpellTypes.DirectDamage);
               _spells.Add("Smite", SpellTypes.DirectDamage);

               // Cooldowns
               _spells.Add("Archangel", SpellTypes.Cooldowns);
               _spells.Add("Shadowfiend", SpellTypes.Cooldowns );
                              
               // Utility
               _spells.Add("Cure Disease", SpellTypes.Utility);
               _spells.Add("Dispel Magic", SpellTypes.Utility);
               _spells.Add("Dispersion", SpellTypes.Utility);
               _spells.Add("Fade", SpellTypes.Utility);
               _spells.Add("Fear Ward", SpellTypes.Utility);
               _spells.Add("Hymn of Hope", SpellTypes.Utility);
               _spells.Add("Leap of Faith", SpellTypes.Utility);
               _spells.Add("Levitate", SpellTypes.Utility);
               _spells.Add("Mana Burn", SpellTypes.Utility);
               _spells.Add("Mind Control", SpellTypes.Utility);
               _spells.Add("Mind Soothe", SpellTypes.Utility);
               _spells.Add("Psychic Scream", SpellTypes.Utility);
               _spells.Add("Psychic Horror", SpellTypes.Utility);
               _spells.Add("Shackle Undead", SpellTypes.Utility);
               _spells.Add("Silence", SpellTypes.Utility);

               // Healing Spells
               _spells.Add("Binding Heal", SpellTypes.Healing);
               _spells.Add("Desperate Prayer", SpellTypes.Healing);
               _spells.Add("Divine Hymn", SpellTypes.Healing);
               _spells.Add("Flash Heal", SpellTypes.Healing);
               _spells.Add("Greater Heal", SpellTypes.Healing);
               _spells.Add("Heal", SpellTypes.Healing);
               _spells.Add("Holy Nova", SpellTypes.Healing); 
               _spells.Add("Power Word: Shield", SpellTypes.Healing);
               _spells.Add("Prayer of Healing", SpellTypes.Healing);
               _spells.Add("Prayer of Mending", SpellTypes.Healing);
               _spells.Add("Renew", SpellTypes.Healing);
               _spells.Add("Resurrection", SpellTypes.Healing);
               
               // Buffs
               _spells.Add("Inner Fire", SpellTypes.Buff);
               _spells.Add("Inner Will", SpellTypes.Buff);
               _spells.Add("Power Word: Fortitude", SpellTypes.Buff);
               _spells.Add("Shadowform", SpellTypes.Buff);
               _spells.Add("Shadow Protection", SpellTypes.Buff);
               _spells.Add("Vampiric Embrace", SpellTypes.Buff);

               //Goblin Racials
               _spells.Add("Rocket Jump", SpellTypes.Racial);
               _spells.Add("Rocket Barrage", SpellTypes.Racial);
        ...
        //public static Boolean IsSpecialMobType(WoWUnit unit, AltarboyHashes.MobTypes MobType)
        //{
        //    if (AltarboyHashes.SpecialMobTypes.Keys.Any(x => x == unit.Entry))
        //    {
        //        if (AltarboyHashes.SpecialMobTypes[unit.Entry].Contains(MobType))
        //        {
        //            return true;
        //        }
        //    }
        ...
        //public static Dictionary<uint, MobTypes[]> SpecialMobTypes
        //{
        //    get
        //    {
        //        var mobs = new Dictionary<uint, MobTypes[]>();          

        //        //TODO - Because we can list multiple flags per mob I think we should organize by instance not the type anymore.

        //        //Firelands
        //        mobs.Add(53631, new MobTypes[] { MobTypes.MindSear, MobTypes.Focus }); // Cinderweb Spiderling (Firelands: Beth'tilac)
        //        mobs.Add(53140, new MobTypes[] { MobTypes.Ignore }); // Son of Flame (Firelands: Ragnaros)
        //        mobs.Add(52593, new MobTypes[] { MobTypes.MindSpike }); // Spirit of the Flame (Firelands: Majordomo Staghelm)

        //        //Blackwing Descent
        //        mobs.Add(42321, new MobTypes[] { MobTypes.MindSear, MobTypes.Focus }); // Lava Parasite (Blackwing Descent: Magmaw)
        //        mobs.Add(43296, new MobTypes[] { MobTypes.UnsafeSWD}); // Chimaeron (Blackwing Descent)

        //        //Bastion of Twilight
        //        mobs.Add(43707, new MobTypes[] { MobTypes.MindSear, MobTypes.Focus }); // Chogall Slime Adds
        //        mobs.Add(43622, new MobTypes[] { MobTypes.Focus }); // Chogall Large add
        //        mobs.Add(44045, new MobTypes[] { MobTypes.Focus ,MobTypes.MindSpike}); // Chogall Mindspike
               

        //        //Baradin Hold
        //        mobs.Add(101006, new MobTypes[] { MobTypes.MindSear, MobTypes.Focus }); //Eyes of Occu'thar
        //        mobs.Add(96920, new MobTypes[] { MobTypes.MindSear, MobTypes.Focus }); //Eyes of Occu'thar

        //        //ZUL'AMAN
        //        mobs.Add(52638, new MobTypes[] { MobTypes.MindSpike, MobTypes.Focus }); // Amani Kidnapper (White Eagle) (Zul'Aman: Akil'zon)
        //        mobs.Add(23586, new MobTypes[] { MobTypes.MindSpike, MobTypes.Focus }); //Amani'shi_Scout
        //        mobs.Add(23581, new MobTypes[] { MobTypes.Focus }); // Amani'shi Medicine Man  
        //        mobs.Add(23596, new MobTypes[] { MobTypes.Focus });  // Amani'shi Flame Caster
        //        mobs.Add(23822, new MobTypes[] { MobTypes.MindSpike, MobTypes.Focus }); //Amani Protective Ward
        //        mobs.Add(52755, new MobTypes[] { MobTypes.Ignore }); //Refreshing Water Totem

        //         // Zul'Gurub
        //        mobs.Add(14988, new MobTypes[] { MobTypes.MindSpike, MobTypes.Focus  }); // Ohgan (Zul'Gurub: Blooddrinker Mandokir)             

        //        // Training Dummies
        //        mobs.Add(31146, new MobTypes[] { MobTypes.Dummy }); // Raider's Training Dummy
        //        mobs.Add(32666,  new MobTypes[] {MobTypes.Dummy}); // Level 60 Dummy
        //        mobs.Add(32667,  new MobTypes[] {MobTypes.Dummy}); // Level 70 Dummy
        //        mobs.Add(46647,  new MobTypes[] {MobTypes.Dummy}); // Level 80 Dummy
        //        mobs.Add(31144, new MobTypes[] { MobTypes.Dummy, MobTypes.Focus }); // Level 85 Dummy
        ...
        public static Boolean TargetHasAuraType(int auraId, AltarboyHashes.AuraTypes auraType)
        {
            if (AltarboyHashes.SpecialAuraTypes.Keys.Any(x => x == auraId))
            {
                if (AltarboyHashes.SpecialAuraTypes[auraId] == auraType)
                {
                    return true;
                }
            }
        ...
        public static Dictionary<int, AuraTypes> SpecialAuraTypes
        {
            get
            {
                var auras = new Dictionary<int, AuraTypes>();

                // Spells to dispel from self immediately
                auras.Add(87618, AuraTypes.DispelAsap); // Static Cling (Vortex Pinnacle: Asaad)
                auras.Add(87619, AuraTypes.DispelAsap); // Static Cling (Vortex Pinnacle: Asaad)
                auras.Add(88954, AuraTypes.DispelAsap); // Consuming Darkness (Baradin Hold: Argaloth 10)
                auras.Add(95173, AuraTypes.DispelAsap); // Consuming Darkness (Baradin Hold: Argaloth 25)
                auras.Add(96958, AuraTypes.DispelAsap); // Lash of Anguish (Zul'Gurub: High Priestess Kilnara)
                auras.Add(96423, AuraTypes.DispelAsap); // Lash of Anguish (Zul'Gurub: High Priestess Kilnara)

                // Spells to never remove from self
                auras.Add(96328, AuraTypes.NeverDispel); // Toxic Torment (Zul'Gurub: Green Cauldron)
                auras.Add(96325, AuraTypes.NeverDispel); // Frostburn Formula (Zul'Gurub: Blue Cauldron)
                auras.Add(96326, AuraTypes.NeverDispel); // Burning Blood (Zul'Gurub: Red Cauldron)
                auras.Add(86788, AuraTypes.NeverDispel); // Blackout (Bastion of Twilight: Valiona 10)
                auras.Add(92877, AuraTypes.NeverDispel); // Blackout (Bastion of Twilight: Valiona 10H)
                auras.Add(92876, AuraTypes.NeverDispel); // Blackout (Bastion of Twilight: Valiona 25)
                auras.Add(92878, AuraTypes.NeverDispel); // Blackout (Bastion of Twilight: Valiona 25H)

                // Spells to purge from enemies immediately
                auras.Add(77912, AuraTypes.PurgeAsap); // Remedy (Blackwing Descent: Maloriak 10)
                auras.Add(92966, AuraTypes.PurgeAsap); // Remedy (Blackwing Descent: Maloriak 10H)
                auras.Add(92965, AuraTypes.PurgeAsap); // Remedy (Blackwing Descent: Maloriak 25)
                auras.Add(92967, AuraTypes.PurgeAsap); // Remedy (Blackwing Descent: Maloriak 25H)
                auras.Add(97485, AuraTypes.PurgeAsap); // Blazing Haste (Zul'Aman trash: Amani'shi Flame Caster)
                // DEV - For these next four, could we maybe move them to SpecialOther and have it only dispel if no mage is in group?
                // DEV - Alternately, we can not do that because screw mages. 
                auras.Add(79729, AuraTypes.PurgeAsap); // Power Conversion (Blackwing Descent: Arcanotron 10) 
                auras.Add(91544, AuraTypes.PurgeAsap); // Power Conversion (Blackwing Descent: Arcanotron 10H)
                auras.Add(91543, AuraTypes.PurgeAsap); // Power Conversion (Blackwing Descent: Arcanotron 25)
                auras.Add(91545, AuraTypes.PurgeAsap); // Power Conversion (Blackwing Descent: Arcanotron 25H)
                auras.Add(43430, AuraTypes.PurgeAsap); // Avenging Wrath (Zul'Aman: Hex Lord Malacrass)
                auras.Add(43421, AuraTypes.PurgeAsap); // Lifebloom (Zul'Aman: Hex Lord Malacrass)

                // Spells to never remove from enemies
                //_auras.Add(0000, AuraTypes.NeverPurge);

                // Other stuff to interact with maybe.
                //_auras.Add(0000, AuraTypes.SpecialOther);
        ...
        public static Dictionary<int, String> Potions
        {
            get
            {
                var potions = new Dictionary<int, String>
                {
