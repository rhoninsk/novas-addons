    ...
    public partial class Zerfall
    {
        ...
        private Composite Demo_Instance()
        {
            return new PrioritySelector(
               ...
               CreateSpellCheckAndCast("Incinerate", ret => SpellManager.HasSpell("Incinerate") && Me.GotTarget), //used to be shadowbolt changed for 4.3

               CreateSpellCheckAndCast("}", ret => !SpellManager.HasSpell("Incinerate") && Me.GotTarget),
