...
*/
            ...
            public static class IDs
            {
                ...
                public static int InnerWill = 73413;               // Passive
                public static int InnerFire = 588;                  // Passive
                public static int PowerWordFortitude = 79105;
                public static int ShadowProtection = 79107;
                public static int PrayerOfMending = 41635;
                public static int WeakenedSoul = 6788;
                public static int PowerWordShield = 17;
                public static int FearWard = 6346;
                public static int InnerFocus = 89485;
                public static int PainSuppression= 33206;
                public static int PowerInfusion = 10060;
                public static int Renew = 139;
                public static int Fade = 586;
                public static int SurgeOfLight = 88687;            // Instant cast Flash Heal
                public static int DevineAegis = 47515;
                public static int Evangelism = 81662;
                public static int ShadowWordPain = 589;
                public static int HolyFire = 14914;
                public static int DevouringPlague = 2944;
                public static int MindSpike = 87178;
                public static int MindSear = 48045;
                public static int Lifeblood = 55428;
                public static int PowerWordBarrier = 81782;         // Passive
                public static int Dispersion = 63230;
                public static int MindFlay = 15407;
                public static int VampiricTouch = 34914;
                public static int ShadowOrb = 77487;
                public static int Silence = 15487;
                public static int VampiricEmbrace = 15286;
                public static int ShadowForm = 107903;
                public static int MindMelt = 87160;
            ...
            public static WoWUnit NeedToDecursePlayer
            {
                get
                {
                    ...
                    if (Me.IsInParty)
                    {
                        ...
                        {
                            if (!p.InLineOfSpellSight) continue;
                ...
                public static bool CanUseTravelForm
                {
                    get
                    {
                        ...
                        if (CLCTravelForm.ToUpper().Contains("AUTOMATIC"))
                            if (CharacterSettings.Instance.UseMount && Me.Level >= 20) return false;
            ...
            public static class Pet
            {
                ...
                public static bool NeedToSummonPet
                {
                    get
                    {
                        ...
                        // No pet means no pet!
                        if (Utils.IsBattleground && BattlegroundPet.ToUpper() == "NO PET") return false;
                        if ((Me.IsInInstance || Me.IsInRaid) && InstancePet.ToUpper() == "NO PET") return false;
                        if (!Utils.IsBattleground && !Me.IsInInstance && (PVEPet.ToUpper() == "NO PET")) return false;
                ...
                public static bool CanCastPetSpell(string petSpellName)
                {
                    bool result = false;
                    if (string.IsNullOrEmpty(petSpellName)) return false;

                    foreach (WoWPetSpell spell in Me.PetSpells)
                    {
                        if (spell.ToString().ToUpper() == petSpellName.ToUpper())
                        {
                            result = !spell.Spell.Cooldown;
                            break;
                        }
                    }
                ...
                public static bool CastPetSpell(string petSpellName)
                {
                    foreach (WoWPetSpell spell in Me.PetSpells)
                    {
                        if (spell.ToString().ToUpper() != petSpellName.ToUpper()) continue;
