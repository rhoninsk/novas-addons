...
namespace Athena
{
        ...
        public static bool CCheck(string spellName, params object[] args)
        {
            ...
            foreach (var obj in args)
            {
                ...
                if (obj is string)
                {
                    ...
                    // Target is....
                    if (debug) Log("** DEBUG: --> " + "TARGET_IS:...", Color.SlateGray);
    ...
    public static class Timers
    {
        ...
        public static void Add(string timerName)
        {
            ...
            if (_timerCollection.ContainsKey(timerName))
            {
                Logging.WriteDebug("**********************************************************************");
                Logging.WriteDebug(" ");
                Logging.WriteDebug(String.Format(" Timer '{0}' already exist in the collection", timerName));
                Logging.WriteDebug(" ");
                Logging.WriteDebug("**********************************************************************");
            }
            else
    ...
    public static class Movement
    {
        ...
        public static void DistanceCheck(double maxDistance, double moveToDistance)
        {
            ...
            {
                Utils.Log("----- DistanceCheck BLA BLA BLA || Target.Distance > maxDistance -----");
            ...
            {
                Utils.Log("----- DistanceCheck Target.Distance <= moveToDistance && Me.IsMoving -----");
            ...
            Utils.Log("----- DistanceCheck STOP MOVING -----");
    ...
    public static class Inventory
    {
        ...
        public static void Drink()
        {
            ...
            CharacterSettings.Instance.DrinkName = drink.Name;
    ...
    {
        private static LocalPlayer Me { get { return ObjectManager.Me; } }
        public static string FileName = @"CustomClasses\Fpsware Priest\Class Specific\Config\Settings.xml";
